...
!function (t, e) {
  ...
  var $ = {
    ...
    for (var n = Dt(t), u = arguments.length, i = 1, r = dt.f, s = l.f; u > i;) for (var o, h = p(arguments[i++]), c = r ? St(h).concat(r(h)) : St(h), f = c.length, d = 0; f > d;) o = c[d++], a && !s.call(h, o) || (n[o] = h[o]);
  ...
  var Se = function () {
    ...
    return zt(t, [{
      ...
      set: function (t) {
        if (!this.maskEquals(t)) if (t instanceof he.Masked || this.masked.constructor !== fe(t)) {
          var e = pe({
            mask: t
          });
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let body = document.querySelector('body'); //var blocker = document.getElementsByClassName('mm-wrapper__blocker');
  ...
  function desktopMenuToggle(e) {
    ...
    body.classList.toggle('fixed'); // модификатор иконки (должен быть .burger)
  }
  ...
  function resizeThrottler() {
    ...
    if (!resizeTimeout) {
      resizeTimeout = setTimeout(function () {
        resizeTimeout = null;
        checkWidth(); // The actualResizeHandler will execute at a rate of 15fps
      }, 100);
    }
  }
});
...
document.addEventListener("DOMContentLoaded", () => {
  const menu = new Mmenu("#mm-menu", {
    // options
    "extensions": ["theme-dark", "popup", "multiline", "border-full" //"border-none" || "border-full"
    ],
    "navbar": {
    ...
    "navbars": [{
      "position": "top",
      "content": ['<div class="mm-close"><img src="img/pakline-logistics-mm.svg" alt="Pakline Logistics" width="114" height="41"><span class="mm-close__btn" role="button" aria-label="Close"></span></div>']
    }]
  }, {
    // configuration
    offCanvas: {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const setPinHeight = function (e) {
    ...
    if (getPageRoute()) {
      pinHeight = windowHeight - getElemHeight(); //console.log( windowHeight - getElemHeight() );
    } else {
  ...
  const scrollHandler = function (e) {
    let header = document.getElementById('sticky-header');
    let pageOffset = window.pageYOffset; //console.log( pageOffset );
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const mapContainer = document.getElementById('map-container'); // Array.prototype.forEach.call(tabElems, function (item) {
  //   console.log(item);
  // });

  $('a[data-toggle="tab"]').on('shown.bs.tab', function (event) {//event.target // newly activated tab

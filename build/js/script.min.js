...
(function () {
  ...
  var toggler = document.getElementById('burger'); //var blocker = document.getElementsByClassName('mm-wrapper__blocker');
  ...
  if (toggler) {
    ...
    function burgerToggle(e) {
      e.preventDefault();
      toggler.classList.toggle('burger--close'); // if ( toggler.classList.contains('burger--close') ) {
